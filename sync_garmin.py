...
def main():
    ...
    try:
        ...
        for day in wellness_data:
            ...
            # Werte sicher abrufen (NoneType-Fehler behoben)
            ...
            # health_row hat jetzt genau 8 Werte (Spalten A bis H)
            health_row = [date_str, sleep_score, sleep_duration, hrv_avg, rhr, steps, vo2_max, acute_load]
            
            if date_str in date_map:
                row_idx = date_map[date_str]
                # Bereich auf A bis H aktualisiert
